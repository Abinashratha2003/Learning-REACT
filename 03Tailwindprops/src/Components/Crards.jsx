...
function Cards(props) { //We can write props or we can use destructing {username} if we have done destructing then there is not need to required props.username we can directly write username below
  return (
    <div>
